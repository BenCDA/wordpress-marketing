						...
						<div class="fea-headbrd">
							<div class="fea-head">
								<div class="fea-headinn">
									<div class="fea-title">
										<?php echo esc_html('OUR', 'online-marketing-agency'); ?>	<br>
										<?php echo esc_html('Features', 'online-marketing-agency'); ?>	
									</div>
									<div class="fea-subtitle">
										<?php echo esc_html('WHAT WE DO', 'online-marketing-agency'); ?>	
									</div>
								</div>
							</div>
						</div>
