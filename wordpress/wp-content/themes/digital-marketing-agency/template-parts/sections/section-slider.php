<div class="<?php if(esc_attr(get_theme_mod('digitalmarketingagency_slider_section_width','Full Width')) == 'Full Width'){ ?>container-fluid pd-0 <?php } elseif(esc_attr(get_theme_mod('digitalmarketingagency_slider_section_width','Full Width')) == 'Box Width'){ ?> container <?php }?>">
                ...
                <div class="slider-inner-box">
                    <div class="container">
                        ...
                        <div data-swiper-parallax="500" class="slide-btns">
                          <a class="ReadMore" href="<?php echo esc_url( get_permalink() ); ?>"><?php esc_html_e('Contact Us','digital-marketing-agency'); ?></a>
                        </div>
                    </div>
                </div>
              </div>          
