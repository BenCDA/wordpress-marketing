...
<div id="post-<?php the_ID(); ?>" <?php post_class('blog-item'); ?>>
	...
	<ul class="comment-timing">
		...
		<li><a href="<?php echo esc_url(get_author_posts_url( get_the_author_meta( 'ID' ) ));?>"><i class="fa fa-user"></i><?php echo esc_html_e('By','digital-marketing-agency'); ?> <?php esc_html(the_author()); ?></a></li>
	</ul>
</div>